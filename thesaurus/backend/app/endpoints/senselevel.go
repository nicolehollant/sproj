...
// GetSenseLevel - Access entries in the collection!
func GetSenseLevel(client *mongo.Client, response http.ResponseWriter, request *http.Request) {
	...
	err = collection.FindOne(ctx, structs.SenseLevelEntry{Word: word}).Decode(&entry)
