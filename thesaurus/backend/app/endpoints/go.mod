module github.com/colehollant/sproj/thesaurus/backend/app/endpoints
...
require (
	...
	github.com/colehollant/sproj/thesaurus/backend/config v0.0.0-20190930183635-b13cbc2a0a34 // indirect
