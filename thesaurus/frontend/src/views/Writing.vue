...
.markdown {
  @apply leading-relaxed text-lg font-medium p-4 max-w-4xl mb-10 mx-auto text-left text-pink-200 -mt-10;
}
.markdown >>> h1 {
  @apply font-black text-3xl text-indigo-200 mt-20 mb-2 uppercase;
}
.markdown >>> h2 {
  @apply font-bold text-2xl text-purple-300 mt-12 mb-2;
}
.markdown >>> h3 {
  @apply font-bold text-xl text-purple-300 mt-8 mb-2;
}
.markdown >>> h4{
  @apply font-bold text-lg text-purple-300 mt-4 mb-1;
}
.markdown >>> p {
  @apply mb-8;
}
